        ...
        with con:
            ...
            for row in rows:
                if row[0] == user and password == row[1]:
                    in_file = open("C:/Users/gowth/OneDrive/Desktop/mini/36.Fingerprint based on ATM System/FingerprintATM/BiometricImages"+user+".png", "rb")
...
def SignupAction():
    if request.method == 'POST':
        ...
        if status == 'none':
            ...
            db_connection.commit()
            if db_cursor.rowcount == 1:
                out_file = open("C:/Users/gowth/OneDrive/Desktop/mini/36.Fingerprint based on ATM System/FingerprintATM/BiometricImages"+user+".png", "wb")
                out_file.write(data)
                out_file.close()
